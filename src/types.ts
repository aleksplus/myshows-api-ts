...
export interface IMyShowsList {
  ...
  listsRemoveShow<T>(id: number): Promise<
    RpcResponse<
      T,
      {
        id: number;
...
export interface IMyShowsManage {
  ...
  manageCheckEpisode<T, R = 1 | 2 | 3 | 4 | 5>(
    id: number,
    rating: R
  ): Promise<
    RpcResponse<
  ...
  manageUnCheckEpisode<T, R = 1 | 2 | 3 | 4 | 5>(
    id: number
  ): Promise<
    RpcResponse<
      T,
  ...
  manageRateEpisode<T, R = 1 | 2 | 3 | 4 | 5>(
    id: number,
    rating: number
  ): Promise<
    RpcResponse<
  ...
  manageRateEpisodesBulk<T, R = 1 | 2 | 3 | 4 | 5>(
    id: number,
    r1: R[],
    r2: R[],
    r3: R[],
...
export interface IMyShowsProfile {
  profileGet<T>(login: string): Promise<
    RpcResponse<
      T,
      {
        login: string;
  ...
  profileFeed<T>(login: string): Promise<
    RpcResponse<
      T,
      {
        login: string;
  ...
  profileFriends<T>(login: string): Promise<
    RpcResponse<
      T,
      {
        login: string;
  ...
  profileFollowers<T>(login: string): Promise<
    RpcResponse<
      T,
      {
        login: string;
  ...
  profileShows<T>(login: string): Promise<
    RpcResponse<
      T,
      {
        login: string;
  ...
  profileEpisodes<T>(showId: number): Promise<
    RpcResponse<
      T,
      {
        showId: number;
...
export interface IMyShowsUsers {
  ...
  usersFiltersCounters<T>(query: string): Promise<
    RpcResponse<
      T,
      {
        query: string;
